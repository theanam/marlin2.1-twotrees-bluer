 ...
 *
 * Options: TMC2208_STANDALONE, A5984, DRV8825, LV8729, TB6560, TB6600, TMC2100,
 ...
 */
#define A_DOUBLE_STEPS false // in some printers, tmc2208 has double steps. so step values will be half.
 ...
 */
#if ENABLED(A_DOUBLE_STEPS)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 400, 405 }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.6, 160.6, 800, 810 }
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -36, -1.35 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN PA4 // MT_DET_PIN
